...
ALTER FUNCTION [dbo].[searchMemberInTeamByName](@team_id int,@name varchar(50)) RETURNS TABLE
AS RETURN (SELECT * FROM AllMember WHERE team_id = @team_id AND name LIKE '%'+@name+'%' AND role_id = 1)
GO
-- End update
